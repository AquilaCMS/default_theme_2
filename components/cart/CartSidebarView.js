...
export default function CartSidebarView({ toggleCart, closeCart }) {
    ...
    return (
        ...
        <div className="w-commerce-commercecartcontainerwrapper w-commerce-commercecartcontainerwrapper--cartType-rightSidebar" style={toggleCart ? {} : { display: 'none' }}>
