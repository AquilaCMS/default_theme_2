            ...
            <div className="navigation-container">
                ...
                <div className="navigation-right">
                    ...
                    <div className="w-commerce-commercecartwrapper">
                        <button type="button" className="w-commerce-commercecartopenlink cart-button w-inline-block" onClick={handleCart}>
                            ...
                            <div className="w-commerce-commercecartopenlinkcount cart-quantity">{cart.items?.length || 0}</div>
                        </button>

                        {toggleCart && <CartSidebarView closeCart={closeCart} />}
