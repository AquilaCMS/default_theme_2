...
import axiosAquilaConnector                        from 'aquila-connector/lib/AxiosInstance';
import { getBlockCMS, getBlocksCMS }               from 'aquila-connector/api/blockcms';
import { getBlogList }                             from 'aquila-connector/api/blog';
import { getCategory, getCategoryProducts }        from 'aquila-connector/api/category';
import { getComponent }                            from 'aquila-connector/api/component';
import { getProduct, getProductById, getProducts } from 'aquila-connector/api/product';
...
export const setTokenAxios = (cookies) => {
    ...
    if (jwt) {
        ...
        axiosAquilaConnector.defaults.headers.common['Authorization'] = jwt;
    } else {
        delete axios.defaults.headers.common['Authorization'];
        delete axiosAquilaConnector.defaults.headers.common['Authorization'];
    }
};
